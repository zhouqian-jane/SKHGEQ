...
export default class Home extends React.Component {
    ...
    componentDidMount() {
        publish('home_worldMap').then((res) => {
            ...
            $('.cesium-viewer-toolbar').css({ zIndex: 2, top: 25, left: 40, right: ' 0 !important ' });
        ...
        return (
            <div className='home' style={{ overflow: 'hidden', height: '100%' }}>
                <div className='homeLeft'>
                    <div id='homeLeft' style={{ width: 7564, height: 3110 }} />
                </div>
                <HomeRightPanelNew />
                {this.state.showTip ?
                    <div className='rightP' style={{ position: 'absolute', top: 250, left: 90, width: 1750, height: 2470, zIndex: 1 }}>
